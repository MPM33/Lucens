...
import type { ProtocolSubInput, ScaleValue } from '@/protocol/types'
import { ScaleInput } from './ScaleInput'
import { ChoiceInput } from './ChoiceInput'

type SubValue = { scale_value?: ScaleValue; choice_id?: string }
          ...
          <div key={sub.id}>
            ...
            {sub.input_type === 'scale_1_5' ? (
              <ScaleInput
                ...
                onChange={(v) => updateSub(sub.id, { scale_value: v as ScaleValue })}
              />
            ) : (
              <ChoiceInput
                options={sub.options ?? []}
